...
TOKENX_DOKUMENT=...
```
Du kan også hente token ved å kjøre `npm run dev:hent-tokens` med personident fra Dolly. Dette gjøre den manuelle prosessen litt enklere, da den fyller ut .env filen automagisk!
3. `npm install` 
4. `npm run dev` 
