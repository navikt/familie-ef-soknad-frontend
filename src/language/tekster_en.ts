...
export default {
  ...
  'stegtittel.oppsummering': 'Summary',
  'stegtittel.barnaDine': 'Your children',
  'stegtittel.andreForelderOgSamvær': 'The other parent and access',
  'stegtittel.lastOppDokumentasjon': 'Upload documentation',
