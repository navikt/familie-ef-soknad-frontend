...
export default {
  ...
  'knapp.startTom': 'Restart the entire application',
  'knapp.startGjenbruk': 'Use the information from the previous application',
  'knapp.sendSøknad': 'Submit application',
  'knapp.lukk': 'Close',
  'feil.ingentekst.sanity': 'No dynamic text found in Sanity',
  'feil.ingentekst.app': 'No static text found',
  'feil.udefinerttekst': 'Undefined text - empty string',
  'feil.alert': 'Something went wrong!',
  ...
  'sivilstatus.kode.REGISTRERT_PARTNER': 'Registered partner',
  ...
  'barnasbosted.spm.andreForelderenSamværNei.ufødt':
    'No, the other parent should not have access to the child',
  ...
  'barnasbosted.hjelpetekst-innhold.harDereSkriftligSamværsavtale':
    'We need information about<ul><li>how many days and nights the child spends with the other parent in a two-week period (or longer)</li><li>when the child travels to and from the other parent</li></ul>',
  ...
  'arbeidssituasjon.spm.hjelpetekst-innhold':
    'We need information about your work situation in order to assess whether you are qualified to receive transitional benefit for single parents. You must be at least 50 per cent engaged in some form of occupational activity after your youngest child has turned 1 year. However, there are some exceptions to the general rule.<br/><br/>Read more about these requirements <a href="https://www.nav.no/overgangsstonad-enslig#aktivitet">here</a>.',
  ...
  'utdanning.lesmer-innhold.privatEllerOffentlig':
    'We only approve private education if the public school system does not have the same offering. <br/><br/>We may accept private education in special circumstances, such as if you were not accepted at a public school or you had started the education at the private institution before you became a single parent.',
  ...
  'utdanning.andreUtgifter.tekst':
    '<strong>Do you have any other expenses in connection with your education?</strong><br /><br />Supplemental benefit can be granted to cover expenses related to:<ul><li>child minding</li><li>learning materials</li><li>daily travel</li><li>travel to gatherings</li><li>travel due to start-up, conclusion or returning home</li><li>housing and overnight accommodation</li><li>relocation</li></ul>We will refer you to the application for supplemental benefit once you have completed this application. You can only receive supplemental benefit if you qualify for transitional benefit.',
  ...
  'dinSituasjon.alert.harSyktBarn':
    'You must provide documentation confirming that your child is ill and describing your ability to be in occupational activity.<br/>The documentation from your doctor must state:<ul><li>why the child’s illness affects your ability to work or be in other occupational activity  </li><li>when the child’s illness started </li><li>when the doctor expects the child to have recovered </li><li>how much you can work </li></ul>When you submit your application, you will be given the option to download or print a checklist that you can take with you when you go to your doctor to document this.',
  'dinSituasjon.alert.harSøktBarnepassOgVenterEnnå':
    'You must provide documentation confirming that you do not have child minding.This means denial of a place in a kindergarten or child care at school outside school hours (SFO), or confirmation that the child is on a waiting list.<br/>The documentation must indicate:<ul><li>the date you applied</li><li>the date you wanted a place from</li></ul>',
  ...
  'dinSituasjon.alert.sagtOpp':
    'You must provide documentation of your employment and the reason you resigned.\n<br/><br/>The documentation must indicate:<ul><li>your employment </li><li>the reason you resigned  </li><li>the date you resigned or arranged a voluntary leave of absence</li></ul>',
  ...
  'filopplaster.dra': 'Upload documentation',
  ...
  'dokumentasjon.utdanning.beskrivelse.skolepenger':
    'The documentation must indicate:<ul><li>the name of the place of study</li><li>the name of the course or education</li><li>how much you are going to study</li><li>the period in which you are going to study</li></ul>The documentation must clearly show who it concerns.',
  'dokumentasjon.utdanning.beskrivelse':
    'The documentation must indicate:<ul><li>the name of the place of study</li><li>the name of the course or education</li><li>how much you are going to study</li><li>the period in which you are going to study</li></ul>The documentation must clearly show who it concerns. <br/><br/>If you are already receiving transitional benefit and are applying for an extension of the benefit period because you have been offered a place on a course of education, the documentation must also show the date on which you accepted the offer.',
  ...
  'dokumentasjon.arbeidsforhold-oppsigelse.beskrivelse':
    'The documentation must indicate: <ul><li>your employment</li><li>the reason you resigned</li><li>the date you resigned or arranged a voluntary leave of absence</li></ul>',
  ...
  'kvittering.beskrivelse.tilleggsstønader':
    'Supplemental benefit can be granted to cover expenses related to<ul><li>child minding</li><li>learning materials</li><li>daily travel</li><li>travel to gatherings</li><li>travel due to start-up, conclusion or returning home</li><li>housing and overnight accommodation</li><li>relocation</li> </ul><br/> <i>NB! You can only receive supplemental benefit if you qualify for transitional benefit</i>',
  ...
  'kvittering.beskrivelse.tilleggsstønader.aktivitetskrav':
    'This benefit covers 64 per cent of your child minding expenses, such as kindergarten, child care at school outside school hours (SFO), or a babysitter or child minder.  <br/><br/> If you earn more than NOK 744 168 a year, you are not entitled to this benefit.',
