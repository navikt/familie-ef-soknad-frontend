...
export const erOvergangsstønadSøknad = (
  søknad: Søknad
): søknad is SøknadOvergangsstønad => 'merOmDinSituasjon' in søknad;

export const erBarnetilsynSøknad = (
  søknad: Søknad
): søknad is SøknadBarnetilsyn =>
  'aktivitet' in søknad &&
  !('merOmDinSituasjon' in søknad) &&
  !('utdanning' in søknad);

export const erSkolepengerSøknad = (
  søknad: Søknad
): søknad is SøknadSkolepenger => 'utdanning' in søknad;
